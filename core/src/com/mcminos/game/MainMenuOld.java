...
public class MainMenuOld implements Screen {
    ...
    public MainMenuOld(final Main main, String levelPreselect) {
        final MainMenuOld thisScreen = this;
        this.main = main;
...
//        table.align(Align.center | Align.top);
        ...
        startButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                thisScreen.dispose();
        // obsolet        main.setScreen(new Play(main, (String) sb.getSelected(), 0, 3));
            }
        });
...
/*
        ...
        // getting disabled sb.setItems(main.getLevelNames().toArray());

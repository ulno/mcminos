...
public class Play implements Screen, GestureListener, InputProcessor {
    ...
    public Play(String levelName) {
        ...
        toolbox.setSize(menu.getWidth() / 3, menu.getHeight() * 2 / 3);
        ...
        toolboxTable.add(leaveButton).pad(4).minSize(128, 64);
        toolboxTable.row();
        ...
        toolboxTable.add(plusButton).pad(4).minSize(64,64);
        toolboxTable.add(minusButton).pad(4).minSize(64,64);

...
/**
 * Handle physical libniControllers conencted to device handled by libgdx.LibniController
 *
...
public class GdxControllerMultiplexer extends LibniController { // TODO: add later actual subcontrollers with creation and deletion listeners
    ...
    public GdxControllerMultiplexer(GdxControllerMapping gdxControllerMapping) {
        super(gdxControllerMapping);
    }

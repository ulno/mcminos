 ...
 */
public class KeyboardMapping extends Mapping {
    @Override
    public KeyboardMapping addButton(int libniButton, int keycode) {
        return (KeyboardMapping) super.addButton(libniButton, keycode);
    }

    @Override
    public KeyboardMapping addButtonFromAnalog(int libniButton, int analogNr, boolean positive) {
        return (KeyboardMapping) super.addButtonFromAnalog(libniButton, analogNr, positive);
    }

    @Override
    public KeyboardMapping addAnalog(int libniAnalog, int analogNr) {
        return (KeyboardMapping) super.addAnalog(libniAnalog, analogNr);
    }
